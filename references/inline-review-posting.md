...
The review's top-level `body` field is the **Korean aggregated summary** the user reads first. It comes from `artifacts/code-review-summary.md` content. Include:
